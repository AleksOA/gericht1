    ...
    <main>
        <div class="blog__top">
            ...
            <div class="blog__top-image">
                <?php $top_image = get_field('post_image_blog');
        ...
        <div class="blog__column-primary">
            <main>
                ...
                <div class="blog__center-item">
                    <?php if( have_rows('data_for_single_post') ):
                            while ( have_rows('data_for_single_post') ) : the_row(); ?>

                               <?php if( get_row_layout() == 'section_one_text' ): ?>
                                  <?php  $text = get_sub_field('text_post_section_one'); ?>
                                    <div class="blog__center-text-one">
                                        <?php if( $text) { echo $text;} ?>
                                    </div>


                                <?php elseif ( get_row_layout() == 'section_video_blog' ): ?>
                                    <?php $video_blog = get_sub_field('video_blog')["url"] ?>
                                    <?php $placeholder_blog = get_sub_field('placeholder_video_blog')["url"] ?>
                                ...
                                <?php elseif ( get_row_layout() == 'section_two_text' ): ?>
                                    <?php $text_two = get_sub_field('text_post_section_two') ?>

                                    <div class="blog__center-text-two">
                                        <?php if( $text_two) { echo $text_two;} ?>
                                    </div>

                                <?php elseif ( get_row_layout() == 'section_quote' ): ?>
                                    <?php $text_quote = get_sub_field('quote_post_text') ?>

                                    <div class="blog__center-quote">
                                        <?php if( $text_quote ) { echo $text_quote;} ?>
                                    </div>

                                <?php elseif ( get_row_layout() == 'section_three_text' ): ?>
                                    <?php $text_text_three = get_sub_field('text_post_section_three') ?>
                                    <?php $text_image_three = get_sub_field('image_post_section_three') ?>
                                    <?php $text_text_two_three = get_sub_field('text_two_post_section_three') ?>
